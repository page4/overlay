...
MOZ_LASTEST_BETA="https://download.mozilla.org/?product=firefox-beta-latest-ssl&os=linux64&lang=en-US"
MOZ_LASTEST_DEV="https://download.mozilla.org/?product=firefox-devedition-latest-ssl&os=linux64&lang=en-US"
...
src_install() {
	...
	# use nightly icons
	local icon_srcdir="${FILESDIR}/browser/branding/nightly"
